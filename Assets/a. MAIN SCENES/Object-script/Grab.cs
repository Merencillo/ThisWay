...
public class Grab : MonoBehaviour {
    ...
    void Update () {
        ...
        //if (OVRInput.GetDown(OVRInput.Button.One)) {Debug.Log(Time.time);}
        //if(Input.GetAxis("Oculus_GearVR_RIndexTrigger") == 1) {Debug.Log(Time.time);}
       
        //if (grabbing && Input.GetAxis("Oculus_GearVR_RIndexTrigger")<1){
           // print("drop again");
        //}
