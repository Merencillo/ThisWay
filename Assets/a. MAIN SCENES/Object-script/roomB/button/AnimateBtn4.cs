...
public class AnimateBtn4 : MonoBehaviour {
	...
	public void Update () {
        _PressBtn.PressingObjectFour();
        _PressBtnL.PressingObjectFour();
        booleanScriptPressObejct = _PressBtn.btnObject4;
        booleanScriptPressObejctL = _PressBtnL.btnObject4;
